<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buyer Login.aspx.cs" Inherits="Farming_managment_system.Buyer_Login" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="Buyer reg.aspx" class="nav-item nav-link">Register</a>
                
                <a href="Buyer Home.aspx" class="nav-item nav-link">Logout</a>
    ...
    <div class="container-fluid p-0">
        ...
        <asp:Panel ID="Panel1" runat="server" Height="386px" BackColor="#CC33FF">
              <table class="w-100">
        <tr>
        ...
        <tr>
            <td class="text-center" colspan="2">
                <asp:Label ID="Label2" runat="server" CssClass="auto-style6" Text="Invalid Username Or Password" Visible="False"></asp:Label>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td class="auto-style10"><span class="auto-style8"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></span><strong>
                <asp:Label ID="Label3" runat="server" CssClass="auto-style8" Text="Username"></asp:Label>
                </strong>
            </td>
        ...
        <tr>
            <td class="text-center" colspan="2">
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Login" BackColor="#993333" BorderColor="#CC3300" ForeColor="Aqua" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Button" BackColor="#993333" BorderColor="Black" ForeColor="Aqua" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td class="text-center" colspan="2">
                <asp:Label ID="Label5" runat="server" Text="Don't Have An Account?" CssClass="auto-style9"></asp:Label>
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Buyer Login.aspx" CssClass="fa-inverse">Register</asp:HyperLink>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
