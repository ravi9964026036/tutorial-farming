<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin Home.aspx.cs" Inherits="Farming_managment_system.Admin_Home" %>
...
<body>
            ...
            <div class="col-lg-6">
                <div class="d-flex align-items-center justify-content-center">
                    <a href="https://localhost:44335/FarmFresh%20Free%20Website%20Template%20-%20Free-CSS.com/organic-farm-website-template/index.html" class="navbar-brand ms-lg-5">
                        <h1 class="m-0 display-4 text-primary"><span class="text-secondary">Farming Management</span> System</h1>
                    </a>
                </div>
            </div>
            <div class="col-lg-3">
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        <a href="https://localhost:44335/FarmFresh%20Free%20Website%20Template%20-%20Free-CSS.com/organic-farm-website-template/index.html" class="navbar-brand d-flex d-lg-none">
            <h1 class="m-0 display-4 text-secondary"><span class="text-white">Farming Management </span>System</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                <a href="Admin Home.aspx" class="nav-item nav-link active">Home</a>
                <a href="Admin Login.aspx" class="nav-item nav-link">Login</a>
                <a href="View Farmer.aspx" class="nav-item nav-link"> Farmer Details</a>
                <a href="ViewBuyers.aspx" class="nav-item nav-link"> Buyer Details</a>
                <a href="View Crops.aspx" class="nav-item nav-link">Crops</a>
                <a href="View Complaints.aspx" class="nav-item nav-link">Complaints</a>
                <a href="View Payment.aspx" class="nav-item nav-link">Payment Details</a>
                <a href="MainPage.aspx" class="nav-item nav-link">Logout</a>
                    </div>
                </div>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img class="w-100" src="./FarmFresh - Organic Farm Website Template_files/carousel-2.jpg" alt="Image">
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
            ...
            <div class="row gx-0">
                <div class="col-md-6">
                    <div class="bg-primary bg-vegetable d-flex flex-column justify-content-center p-5" style="height: 300px;">
                        ...
                        <a class="text-white fw-bold" href="https://localhost:44335/FarmFresh%20Free%20Website%20Template%20-%20Free-CSS.com/organic-farm-website-template/index.html">Read More<i class="bi bi-arrow-right ms-2"></i></a>
                    </div>
                </div>
                <div class="col-md-6">
