<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin Login.aspx.cs" Inherits="Farming_managment_system.Admin_Login" %>
...
<body>
            ...
            <div class="col-lg-6">
                <div class="d-flex align-items-center justify-content-center">
                    <a href="https://localhost:44335/FarmFresh%20Free%20Website%20Template%20-%20Free-CSS.com/organic-farm-website-template/index.html" class="navbar-brand ms-lg-5">
                        <h1 class="m-0 display-4 text-primary"><span class="text-secondary">Farming Manag</span>ement System</h1>
                    </a>
                </div>
            </div>
            <div class="col-lg-3">
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="Admin Home.aspx" class="nav-item nav-link active">Logout</a>
    ...
    <div class="container-fluid p-0">
      ...
      <center>  <asp:Panel ID="Panel1" runat="server" Height="352px" Width="518px" BackColor="#CC00FF">
              <table class="w-100">
        <tr>
        ...
        <tr>
            <td class="text-center" colspan="2">
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Login" BackColor="#990000" BorderColor="Black" CssClass="auto-style12" ForeColor="Lime" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server" OnClick="Button1_Click" Text="Cancle" BackColor="Maroon" BorderColor="Black" ForeColor="Lime" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
